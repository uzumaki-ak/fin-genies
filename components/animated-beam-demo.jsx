...
import { BitcoinIcon, DollarSign, LandmarkIcon, PiggyBank, ReceiptIndianRupee, Sparkle, Wallet } from "lucide-react";
...
export const AnimatedBeamMultipleOutputDemo = ({ className }) => {
  ...
  return (
    <div
      className={cn(
        "relative flex h-[500px] w-full items-center justify-center overflow-hidden rounded-3xl border bg-zinc-900 p-10 md:shadow-xl",
        className
      )}
      ref={containerRef}
    >
