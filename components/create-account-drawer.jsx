        ...
        <div className="px-4 pb-4">
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            <div className="space-y-2">
              ...
              {/* to connet with react hook form we used ...register  */}
              <Input
                id="name"
              ...
              {/* checkng for error  */}
              {errors.name && (
                <p className="text-rose-900 text-sm font-extralight ">
                  {errors.name.message}
                </p>
              )}
            </div>
            <div className="space-y-2">
              ...
              >
                <SelectTrigger id="type">
                  <SelectValue placeholder="select ttype" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="flex items-center justify-between rounded-lg border p-3">
              <div className="space-y-0.5">
                ...
                <p className="text-sm text-muted-foreground">
                  dis acc will be selected by default for transactions
                </p>
              </div>
              <Switch
                id="isDefault"
